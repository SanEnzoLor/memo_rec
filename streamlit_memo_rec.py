...
def main():
    ...
    with col1:
        st.image("https://github.com/SanEnzoLor/memo_rec/blob/main/image/logo_unige.png", use_container_width=True)
    with col2:
        st.image("https://github.com/SanEnzoLor/memo_rec/blob/main/image/logo_nextage.png", use_container_width=True)
